<div id="post-preview" class="wpallimport-preview_prices">
	...
	<div class="wpallimport-preview-content">
		...
		<p><?php _e('Sale Price', 'wp_all_import_plugin'); ?>: <?php echo empty($product_sale_price) || !empty($product_regular_price) && $product_sale_price > $product_regular_price ? '' : $product_sale_price; ?></p>
